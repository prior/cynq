...
ATTR_COMPONENTS = ('pushed', 'pulled', 'shared')

class RemoteSpec(BaseSpec):

    # overrideable specs
    name = None  # unique string name for this remote

    fresh_store = None # store kls 
    snapshot_store = None # store kls

    pushed = ()  # list of items that are generated by this remote and can never be written to this remote
    pulled = ()  # lsit of items that are written to this remote and are never generated by this remote
