...
class FacetStore(BaseStore):
    ...
    def _bulk_delete(self, keys): return self.proxy_store._bulk_delete(keys)

    def _single_create(self, dobj): return self.proxy_store._single_create(dobj)
    def _single_update(self, key, obj, dchanges): return self.proxy_store._single_update(key, obj, dchanges)
    def _single_delete(self, key): return self.proxy_store._single_delete(key)
